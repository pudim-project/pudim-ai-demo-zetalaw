...
- Restaged the public theory as `THEORY_v017` with authorship `Domingos S. P. Salazar` and `Pudim AI`.
- Promoted APP-0071 through APP-0080, bringing the public solved ledger to 80 applications.
...
- PDF: `theory/versions/v017/THEORY_v017.pdf`
- TeX: `theory/versions/v017/THEORY_v017.tex`
- Application ledger: `APPLICATIONS.md`
- Wiki snapshot: `wiki/versions/stage_v017`
