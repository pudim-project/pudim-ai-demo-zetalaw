---
id: "T-Erdos536-core-shield-lexicographic-complexity-well-founded"
type: "theorem"
title: "Erdos536 core shield lexicographic complexity well founded"
status: "proved"
tags: ["common-core", "complexity", "descent", "endpoint-shield", "erdos-536", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 core shield lexicographic complexity well founded

## Statement

Core/shield lexicographic complexity well-foundedness: any finite-model tuple \(\mathcal C=(\ell_{\mathrm{end}},w_{\mathrm{core}},m_{\mathrm{avail}},r_{\mathrm{width}})\in\mathbb N^4\), ordered lexicographically, is well-founded. Therefore a core/shield descent that strictly decreases this tuple must terminate.
...
`common-core`, `complexity`, `descent`, `endpoint-shield`, `erdos-536`, `proved`, `student-proof`, `theorem`, `true`
