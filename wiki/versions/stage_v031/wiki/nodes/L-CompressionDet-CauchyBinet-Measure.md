---
id: "L-CompressionDet-CauchyBinet-Measure"
type: "lemma"
title: "Cauchy-Binet compression measure"
status: "proved"
tags: ["app-0088-bridge", "bridge-lemma", "cauchy-binet", "coefficient-extraction", "compression-determinant", "finite-kernel", "lemma", "proved", "true"]
parents: ["D-Compression-Determinant-Polynomial"]
refs: ["oracle/responses/OS-20260622T141938Z-oracle-response.md", "raw/student/20260622T1438-bourin-compressiondet.md"]
---

# Lemma: Cauchy-Binet compression measure

## Statement

For every isometry \(V:\mathbb C^k\to\mathbb C^n\), \(g_V(x)=\det(V^*\operatorname{diag}(x)V)=\sum_{|S|=k}|\det V_S|^2\prod_{i\in S}x_i\), and \(\sum_{|S|=k}|\det V_S|^2=1\).

## Dependencies

- [[wiki/nodes/D-Compression-Determinant-Polynomial|Compression determinant polynomial]]
...
`app-0088-bridge`, `bridge-lemma`, `cauchy-binet`, `coefficient-extraction`, `compression-determinant`, `finite-kernel`, `lemma`, `proved`, `true`
