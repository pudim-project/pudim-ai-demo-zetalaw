...
id: "L-PD-Inverse-ODE"
type: "lemma"
title: "Pearse-Bondell inverse ODE"
status: "proved"
tags: ["app-0092-bridge", "bridge", "inverse-ode", "lemma", "power-divergence", "proved", "true"]
parents: ["D-Power-Divergence-Generator-Pearse-Bondell", "D-PD-Strict-Inverse-Lambda-LeMinusOne"]
refs: ["raw/student/20260623T0428-pd-copula-inverse-cm.md"]
---

# Lemma: Pearse-Bondell inverse ODE

## Statement

For \(\lambda=-\gamma\le -1\) and \(u_\gamma(t)=\phi_{-\gamma}^{-1}(t)\), the strict inverse satisfies \(u_\gamma'(t)=-\gamma u_\gamma(t)^\gamma/(1-u_\gamma(t)^\gamma)\) for \(t>0\).

## Dependencies

- [[wiki/nodes/D-Power-Divergence-Generator-Pearse-Bondell|Pearse-Bondell power-divergence generator]]
...
`app-0092-bridge`, `bridge`, `inverse-ode`, `lemma`, `power-divergence`, `proved`, `true`
