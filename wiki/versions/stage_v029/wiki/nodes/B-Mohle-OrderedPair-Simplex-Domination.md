---
id: "B-Mohle-OrderedPair-Simplex-Domination"
type: "lemma"
title: "Ordered-pair simplex domination"
status: "proved"
tags: ["bridge-lemma", "finite-kernel-certificate", "finite-simplex", "lemma", "ordered-pair-kernel", "primitive-support", "proved", "true"]
parents: ["B-Mohle-BinomialCollisionKernel-Integral", "D-Finite-dimensional-l1-dual-certificate-language", "T-Exact-finite-certificate-verification-principle"]
...
# Lemma: Ordered-pair simplex domination
...
`bridge-lemma`, `finite-kernel-certificate`, `finite-simplex`, `lemma`, `ordered-pair-kernel`, `primitive-support`, `proved`, `true`
