---
id: "B-HausdorffMoment-FiniteDifference-Criterion"
type: "theorem"
title: "Hausdorff finite-difference criterion"
status: "proved"
tags: ["bridge-theorem", "complete-monotonicity", "finite-certificate", "finite-difference", "hausdorff-moment", "moment-sequence", "primitive-support", "proved", "theorem", "true"]
parents: ["D-Complete-monotonicity-Bernstein-Stieltjes-language", "T-Exact-finite-certificate-verification-principle"]
...
# Theorem: Hausdorff finite-difference criterion
...
`bridge-theorem`, `complete-monotonicity`, `finite-certificate`, `finite-difference`, `hausdorff-moment`, `moment-sequence`, `primitive-support`, `proved`, `theorem`, `true`
