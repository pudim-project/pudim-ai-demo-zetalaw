...
status: "proved"
tags: ["application-candidate", "bernstein-function", "power-means", "proved", "route-kill", "source-slice-solved", "stolarsky-means", "theorem"]
parents: []
...
`application-candidate`, `bernstein-function`, `power-means`, `proved`, `route-kill`, `source-slice-solved`, `stolarsky-means`, `theorem`
