---
id: "B-DeterministicQuadraticScaleTail-SolutionCriterion"
type: "lemma"
title: "Deterministic quadratic scale tail solution criterion"
status: "proved"
tags: ["app-0091-bridge", "distributional-equation", "lemma", "proved", "scale-identity", "survival-function", "true"]
parents: ["T-Special-function-normal-form-calculus-principle"]
refs: ["raw/student/20260623T0016-equation16-weibull-noncm.md"]
---

# Lemma: Deterministic quadratic scale tail solution criterion

## Statement

Let \(b\in(0,1)\), \(c>0\), and \(\alpha>0\) satisfy \(2b^\alpha=1\). Then \(F(x)=e^{-cx^\alpha}\) solves \(F(x)=F(bx)^2\) on \([0,\infty)\).
...
`app-0091-bridge`, `distributional-equation`, `lemma`, `proved`, `scale-identity`, `survival-function`, `true`
