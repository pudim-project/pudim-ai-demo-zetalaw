---
id: "T-GRWS-SectorII-No-BF-WeightSquared-Interpolation"
type: "theorem"
title: "GRWS Sector II weights squared sequence not interpolated by Bernstein function"
status: "proved"
tags: ["GRWS", "app-candidate", "bernstein-function", "hausdorff-moment", "negative-answer", "primitive-growth", "proved", "signed-atomic-obstruction", "source-open-solved", "theorem", "true", "weighted-shift"]
parents: ["L-BF-Integer-Increments-Are-Hausdorff-CM", "L-Signed-Atomic-Hausdorff-Negativity-Obstruction", "L-GRWS-SectorII-Difference-Atomic-Expansion"]
refs: ["librarian/audits/LA-20260612T2320-grws-sectorii-first-contact.json", "librarian/audits/LA-20260612T2345-grws-sectorii-bf-interpolation.json", "oracle/responses/OS-20260612T2330Z-grws-sectorii-bf-oracle-response.md", "raw/student/20260612T2340-grws-sectorii-bf-interpolation.md", "wiki/notes/frontier-grws-sectorii-bernstein-interpolation.md"]
---

# Theorem: GRWS Sector II weights squared sequence not interpolated by Bernstein function
...
- [[wiki/nodes/L-BF-Integer-Increments-Are-Hausdorff-CM|Bernstein function integer first differences Hausdorff moment sequence]]
- [[wiki/nodes/L-Signed-Atomic-Hausdorff-Negativity-Obstruction|signed atomic Hausdorff negative atom obstruction positive measure uniqueness]]
- [[wiki/nodes/L-GRWS-SectorII-Difference-Atomic-Expansion|GRWS Sector II first difference signed atomic Hausdorff expansion negative q squared atom]]

## Proof and provenance references

- `librarian/audits/LA-20260612T2320-grws-sectorii-first-contact.json`
...
- Do not claim the square-root weights \(\alpha_n\) are not Bernstein-interpolated.
- Do not claim the boundary \(D=0\) is covered.
- Do not claim anything about Sector III or any other GRWS region.

## Tags

`GRWS`, `app-candidate`, `bernstein-function`, `hausdorff-moment`, `negative-answer`, `primitive-growth`, `proved`, `signed-atomic-obstruction`, `source-open-solved`, `theorem`, `true`, `weighted-shift`
