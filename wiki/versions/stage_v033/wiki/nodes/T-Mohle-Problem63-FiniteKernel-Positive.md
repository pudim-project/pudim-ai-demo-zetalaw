---
id: "T-Mohle-Problem63-FiniteKernel-Positive"
type: "theorem"
title: "Mohle Problem 6.3 finite-kernel positivity"
status: "proved"
tags: ["APP-0084", "application-candidate", "block-counting-process", "concentration-inequality", "exchangeable-coalescents", "finite-kernel-certificate", "finite-simplex", "mohle", "open-problem-solved", "proved", "source-solving", "strict-private-app", "theorem", "true"]
parents: ["D-Mohle-BlockCounting-Problem63-Language", "B-Mohle-BinomialCollisionKernel-Integral", "B-Mohle-OrderedPair-Simplex-Domination", "B-Mohle-CountableSimplex-TruncationClosure", "O-Mohle-BlockCounting-Dust-Problem63-source-gate", "T-Exact-finite-certificate-verification-principle"]
refs: ["librarian/audits/LA-20260622T1100-mohle-problem63-strict-app.json", "oracle/responses/OS-20260622T1045Z-mohle-problem63-compact-oracle-response.md", "raw/student/20260622T1058-mohle-problem63-finite-kernel.md"]
---

# Theorem: Mohle Problem 6.3 finite-kernel positivity
...
- [[wiki/nodes/B-Mohle-OrderedPair-Simplex-Domination|Ordered-pair simplex domination]]
- [[wiki/nodes/B-Mohle-CountableSimplex-TruncationClosure|Countable simplex truncation closure]]
- [[wiki/nodes/O-Mohle-BlockCounting-Dust-Problem63-source-gate|Mohle block-counting dust Problem 6.3 source gate]]
...
- `oracle/responses/OS-20260622T1045Z-mohle-problem63-compact-oracle-response.md`
...
- Do not claim any result beyond the exact source Problem 6.3 inequality.
- Do not claim a new convergence-rate theorem unless separately derived from the source.
- Do not public-stage without explicit user request.

## Tags

`APP-0084`, `application-candidate`, `block-counting-process`, `concentration-inequality`, `exchangeable-coalescents`, `finite-kernel-certificate`, `finite-simplex`, `mohle`, `open-problem-solved`, `proved`, `source-solving`, `strict-private-app`, `theorem`, `true`
