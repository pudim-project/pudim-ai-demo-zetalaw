---
id: "L-QuadraticDenominator-CM-NonpositiveRoots"
type: "lemma"
title: "Quadratic denominator with nonpositive roots is completely monotone"
status: "proved"
tags: ["bernstein-functions", "bridge-lemma", "complete-monotonicity", "laplace-transform", "lemma", "proved", "rational-certificate", "true"]
...
# Lemma: Quadratic denominator with nonpositive roots is completely monotone
...
`bernstein-functions`, `bridge-lemma`, `complete-monotonicity`, `laplace-transform`, `lemma`, `proved`, `rational-certificate`, `true`
