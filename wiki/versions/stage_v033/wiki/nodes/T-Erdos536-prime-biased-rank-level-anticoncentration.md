---
id: "T-Erdos536-prime-biased-rank-level-anticoncentration"
type: "theorem"
title: "Erdos536 prime biased rank level anticoncentration"
status: "proved"
tags: ["erdos-536", "poisson-binomial", "prime-biased", "proved", "rank-level", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 prime biased rank level anticoncentration

## Statement

Prime-biased rank-level anti-concentration: for \(X_k=\sum_{i\le k}B_i\) with independent \(B_i\sim\operatorname{Bernoulli}(1/p_i)\), letting \(V_k=\sum_{i\le k}(1/p_i)(1-1/p_i)\), one has \(\sup_m\mathbb P(X_k=m)\le C V_k^{-1/2}\). Since \(V_k\asymp\sum_{i\le k}1/p_i\to\infty\), every single rank level has \(\nu_k\)-mass \(o(1)\).
...
`erdos-536`, `poisson-binomial`, `prime-biased`, `proved`, `rank-level`, `student-proof`, `theorem`, `true`
