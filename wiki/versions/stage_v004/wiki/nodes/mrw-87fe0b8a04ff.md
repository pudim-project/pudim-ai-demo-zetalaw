...
Advisory proposed solution for Candidate 1: an unaudited candidate proposes a telescoping enclosure for
\[
...
Proof-audit risks:
- The candidate write-up contains malformed display math and at least one corrupted identity line in the first telescoping comparison.
