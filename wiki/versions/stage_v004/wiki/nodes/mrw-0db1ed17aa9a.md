...
- The algebraic Laplace pieces, regrouping identities, and numerical sign checks were locally audited in `calculations/verify_p0_concavity_cm.py` before promotion.
