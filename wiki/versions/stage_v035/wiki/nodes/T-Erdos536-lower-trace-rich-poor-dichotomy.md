---
id: "T-Erdos536-lower-trace-rich-poor-dichotomy"
type: "theorem"
title: "Erdos536 lower trace rich poor dichotomy"
status: "proved"
tags: ["dichotomy", "erdos-536", "lower-trace", "proved", "student-proof", "theorem", "true"]
parents: ["T-Erdos536-two-gate-admissibility-data-schema"]
refs: ["attack-plans/AP-20260606T1934-erdos536-local-executable-subfrontier.json", "librarian/audits/LA-20260606T1945-erdos536-local-subfrontier-depletion-student.json", "oracle/responses/OS-20260606T222556Z-oracle-response.md", "raw/oracle/RO-OS-20260606T222556Z.json", "raw/student/20260606T1945-erdos536-local-subfrontier-depletion.md"]
---

# Theorem: Erdos536 lower trace rich poor dichotomy

## Statement

Lower-trace rich/poor dichotomy: for any family \(\mathcal F_k\), any top law \(\tau_k\) on occupied tops, and any threshold \(\delta_k\ge0\), either \(\tau_k\{C:\mathcal L_{\mathcal F_k}(C)\ne\varnothing\}<\delta_k\) or the complementary lower-trace-rich inequality holds. The lower-trace-poor branch cannot be analyzed by defect laws without additional conditioning, while the lower-trace-rich branch permits conditional defect-law analysis.
...
- `attack-plans/AP-20260606T1934-erdos536-local-executable-subfrontier.json`
- `librarian/audits/LA-20260606T1945-erdos536-local-subfrontier-depletion-student.json`
- `oracle/responses/OS-20260606T222556Z-oracle-response.md`
- `raw/oracle/RO-OS-20260606T222556Z.json`
- `raw/student/20260606T1945-erdos536-local-subfrontier-depletion.md`
...
_Proof source: `raw/student/20260606T1945-erdos536-local-subfrontier-depletion.md`._

## Tags

`dichotomy`, `erdos-536`, `lower-trace`, `proved`, `student-proof`, `theorem`, `true`
