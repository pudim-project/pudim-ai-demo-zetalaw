---
id: "T-Erdos536-weighted-container-density-increment"
type: "theorem"
...
# Theorem: Erdos 536 weighted container density increment dichotomy for prime biased union free families
...
- `wiki/versions/stage_v006/wiki/nodes/mrw-30aae977a4b6.md`
- `wiki/versions/stage_v006/wiki/nodes/mrw-55a8d9eddd2e.md`
- `wiki/versions/stage_v006/wiki/nodes/mrw-9e0b4f1a5c33.md`

## Tags

`container`, `density-increment`, `erdos-536`, `open`, `theorem`, `union-free`
