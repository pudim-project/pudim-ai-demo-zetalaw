---
id: "L-ProjectionDPP-Covariance-Laplacian"
type: "lemma"
title: "Projection-DPP covariance Laplacian"
status: "proved"
tags: ["app-0088-bridge", "bridge-lemma", "covariance-laplacian", "determinant", "lemma", "matrix-inequality", "projection-dpp", "proved", "true"]
parents: ["L-CompressionDet-CauchyBinet-Measure"]
refs: ["oracle/responses/OS-20260622T141938Z-oracle-response.md", "raw/student/20260622T1438-bourin-compressiondet.md"]
---

# Lemma: Projection-DPP covariance Laplacian

## Statement

Let \(\Phi(y)=\log\det(V^*\operatorname{diag}(e^y)V)\). With \(K_y=M_y(M_y^*M_y)^{-1}M_y^*\), \(M_y=\operatorname{diag}(e^{y_i/2})V\), one has \(r^T\nabla^2\Phi(y)s=\sum_{i<j}|(K_y)_{ij}|^2(r_i-r_j)(s_i-s_j)\).
...
`app-0088-bridge`, `bridge-lemma`, `covariance-laplacian`, `determinant`, `lemma`, `matrix-inequality`, `projection-dpp`, `proved`, `true`
