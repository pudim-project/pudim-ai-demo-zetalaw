---
id: "T-Erdos536-projective-design-near-top-shadow-identity"
type: "theorem"
title: "Erdos536 projective design near top shadow identity"
status: "proved"
tags: ["erdos-536", "near-top-shadow", "projective-plane", "proved", "spread-design", "student-proof", "theorem", "true"]
parents: ["T-Erdos536-two-gate-admissibility-data-schema"]
refs: ["attack-plans/AP-20260606T2147-erdos536-ltp-design-moving-route.json", "librarian/audits/LA-20260606T2202-erdos536-ltp-design-moving-depletion-student.json", "oracle/responses/OS-20260606T232242Z-oracle-response.md", "raw/oracle/RO-OS-20260606T232242Z.json", "raw/student/20260606T2202-erdos536-ltp-design-moving-depletion.md"]
---

# Theorem: Erdos536 projective design near top shadow identity

## Statement

Projective-design near-top shadow identity: in a projective-plane-like defect system below a top \(C\), if distinct line defects \(D,E\) meet in the single point \(x\), then their complement traces \(A_D=C\setminus D\) and \(A_E=C\setminus E\) satisfy \(A_D\cup A_E=C\setminus\{x\}\). Thus every intersecting design pair produces a near-top shadow, so any global realization must either account for such shadows, shield them, or pay the deletion-mass penalty.
...
- `attack-plans/AP-20260606T2147-erdos536-ltp-design-moving-route.json`
- `librarian/audits/LA-20260606T2202-erdos536-ltp-design-moving-depletion-student.json`
- `oracle/responses/OS-20260606T232242Z-oracle-response.md`
- `raw/oracle/RO-OS-20260606T232242Z.json`
- `raw/student/20260606T2202-erdos536-ltp-design-moving-depletion.md`
...
_Proof source: `raw/student/20260606T2202-erdos536-ltp-design-moving-depletion.md`._

## Tags

`erdos-536`, `near-top-shadow`, `projective-plane`, `proved`, `spread-design`, `student-proof`, `theorem`, `true`
