---
id: "O-Townes-FiniteInterval-BLT-Root-Counterexample"
type: "theorem"
title: "Townes finite-interval BLT root-preservation counterexample"
status: "proved"
tags: ["bilateral-laplace-transform", "counterexample", "finite-interval-complete-monotonicity", "proved", "rational-certificate", "refutation-route", "theorem", "townes"]
parents: ["O-Townes-FiniteInterval-BLT-Root-Preservation", "T-Finite-Dimensional-L1-Dual-Certificate-Exact-Norm-20260609", "D-Rational-certificate-and-finite-cover-language"]
refs: ["attack-plans/AP-20260609T1640-townes-finite-cone-counterexample.json", "librarian/audits/LA-20260609T1645-townes-root-preservation-attack-plan.json", "raw/student/20260609T1705-townes-root-preservation-counterexample.md"]
---

# Theorem: Townes finite-interval BLT root-preservation counterexample
...
- [[wiki/nodes/O-Townes-FiniteInterval-BLT-Root-Preservation|Townes finite-interval BLT root-preservation restatement]]
...
- `attack-plans/AP-20260609T1640-townes-finite-cone-counterexample.json`
- `librarian/audits/LA-20260609T1645-townes-root-preservation-attack-plan.json`
...
- Do not accept sampled derivative signs as a counterexample; require a rational or finite-cover certificate.
- Do not use a law that is not a genuine probability law or whose BLT is not finite on the required interval.

## Tags

`bilateral-laplace-transform`, `counterexample`, `finite-interval-complete-monotonicity`, `proved`, `rational-certificate`, `refutation-route`, `theorem`, `townes`
