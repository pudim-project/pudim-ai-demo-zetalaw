---
id: "T-Erdos536-conditional-defect-coordinate-L2-disjointness-sieve"
type: "theorem"
title: "Erdos536 conditional defect coordinate L2 disjointness sieve"
status: "proved"
tags: ["coverage", "defect-sets", "erdos-536", "l2-sieve", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 conditional defect coordinate L2 disjointness sieve

## Statement

Conditional defect coordinate \(L^2\) disjointness sieve: for any probability law \(\lambda\) on subsets of a finite set \(C\), with \(q_i=\lambda\{D:i\in D\}\), independent \(D,E\sim\lambda\) satisfy \(\lambda^{\otimes2}\{D\cap E\ne\varnothing\}\le\sum_{i\in C}q_i^2\), and therefore \(\lambda^{\otimes2}\{D\cap E=\varnothing\}\ge1-\sum_{i\in C}q_i^2\).
...
`coverage`, `defect-sets`, `erdos-536`, `l2-sieve`, `proved`, `student-proof`, `theorem`, `true`
