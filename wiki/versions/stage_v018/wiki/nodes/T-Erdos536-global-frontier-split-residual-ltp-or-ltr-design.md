---
id: "T-Erdos536-global-frontier-split-residual-ltp-or-ltr-design"
type: "theorem"
title: "Erdos536 global frontier split residual lower trace poor or lower trace rich design"
status: "proved"
tags: ["erdos-536", "frontier-split", "lower-trace-poor", "lower-trace-rich", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 global frontier split residual lower trace poor or lower trace rich design

## Statement

Global frontier split: after applying the conditional lower-trace-poor vanishing theorem to non-residual lower-trace-poor branches, any remaining positive-mass non-rank-thin admissible countermodel must lie either in the residual union-free moving-base high-multiplicity lower-trace-poor frontier or in a lower-trace-rich coordinate-coverage/spread-design branch. This is a structural decomposition of the remaining frontier, not a terminal solution.
...
`erdos-536`, `frontier-split`, `lower-trace-poor`, `lower-trace-rich`, `proved`, `student-proof`, `theorem`, `true`
