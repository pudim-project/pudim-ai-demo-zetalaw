---
id: "T-Erdos536-projective-plane-complement-traces-avoid-basic-comparable-union-obstruction"
type: "theorem"
title: "Erdos536 projective plane complement traces avoid basic comparable union obstruction"
status: "proved"
tags: ["erdos-536", "intersecting-design", "lower-trace", "projective-plane", "proved", "student-proof", "theorem", "true"]
parents: ["T-Erdos536-two-gate-admissibility-data-schema"]
refs: ["attack-plans/AP-20260606T2124-erdos536-design-aware-route.json", "librarian/audits/LA-20260606T2138-erdos536-design-aware-route-depletion-student.json", "oracle/responses/OS-20260606T231402Z-oracle-response.md", "raw/oracle/RO-OS-20260606T231402Z.json", "raw/student/20260606T2138-erdos536-design-aware-route-depletion.md"]
---

# Theorem: Erdos536 projective plane complement traces avoid basic comparable union obstruction

## Statement

Projective-plane complement-trace obstruction normal form: for a projective plane of order \(q\ge2\) with top \(C\) and line defects \(D\), the formal traces \(A_D=C\setminus D\) are pairwise incomparable, and for distinct lines \(D,E\), \(A_D\cup A_E=C\setminus(D\cap E)\ne C\). Thus projective-plane complement traces are not excluded by the basic comparable-pair or union-to-top obstruction.
...
- `attack-plans/AP-20260606T2124-erdos536-design-aware-route.json`
- `librarian/audits/LA-20260606T2138-erdos536-design-aware-route-depletion-student.json`
- `oracle/responses/OS-20260606T231402Z-oracle-response.md`
- `raw/oracle/RO-OS-20260606T231402Z.json`
- `raw/student/20260606T2138-erdos536-design-aware-route-depletion.md`
...
_Proof source: `raw/student/20260606T2138-erdos536-design-aware-route-depletion.md`._

## Tags

`erdos-536`, `intersecting-design`, `lower-trace`, `projective-plane`, `proved`, `student-proof`, `theorem`, `true`
