---
id: "T-BPV-noncentral-chi-square-HCM-optimal-range-open"
type: "theorem"
title: "BPV noncentral chi-square HCM optimal parameter range open problem"
status: "proved"
tags: ["HCM", "app-0047-candidate", "application-candidate", "baricz-prabhu-singh-vijesh", "modified-bessel", "noncentral-chi-square", "proved", "source-open-solved", "source-solving-tool", "theorem"]
parents: ["T-Pointwise-obstruction-certificate-principle"]
refs: ["attack-plans/AP-20260531T062200-noncentral-chi-square-hcm.json", "librarian/audits/LA-20260605T-bpv-noncentral-chi-square-laguerre-total-obstruction.json", "raw/scout/RS-FI-20260531T-rolling-069.json", "raw/scout/sources/bpv-noncentral-chi-square-hcm-source-status.md", "raw/source-cache/bpv-noncentral-chi-square-hcm-2406.17721/distributions.tex", "raw/student/20260605T-bpv-noncentral-chi-square-laguerre-total-obstruction.md", "scout/forage/inbox/FI-20260531T-rolling-069.json", "wiki/notes/frontier-noncentral-chi-square-hcm.md"]
---

# Theorem: BPV noncentral chi-square HCM optimal parameter range open problem

## Statement

Determine the optimal parameter range \((\mu,\lambda)\), with \(\mu>0\) and \(\lambda>0\), for which the noncentral chi-square density \(\chi_{\mu,\lambda}\) is hyperbolically completely monotone.
...
- `raw/scout/RS-FI-20260531T-rolling-069.json`
- `raw/scout/sources/bpv-noncentral-chi-square-hcm-source-status.md`
- `raw/source-cache/bpv-noncentral-chi-square-hcm-2406.17721/distributions.tex`
- `raw/student/20260605T-bpv-noncentral-chi-square-laguerre-total-obstruction.md`
- `scout/forage/inbox/FI-20260531T-rolling-069.json`
...
`HCM`, `app-0047-candidate`, `application-candidate`, `baricz-prabhu-singh-vijesh`, `modified-bessel`, `noncentral-chi-square`, `proved`, `source-open-solved`, `source-solving-tool`, `theorem`
