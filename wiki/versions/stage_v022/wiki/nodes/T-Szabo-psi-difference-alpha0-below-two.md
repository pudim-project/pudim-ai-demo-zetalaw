---
id: "T-Szabo-psi-difference-alpha0-below-two"
type: "theorem"
title: "Szabo psi difference sharp threshold is strictly below 2"
status: "proved"
tags: ["digamma", "partial", "proved", "szabo", "theorem", "threshold"]
parents: ["T-Szabo-psi-difference-alpha2-not-CM", "T-Szabo-psi-difference-alpha0-exact-one", "D-Complete-monotonicity-Bernstein-Stieltjes-language"]
refs: ["librarian/audits/LA-20260530T214500-szabo-psi-difference-alpha2-obstruction.json", "raw/student/20260530T214500-szabo-psi-difference-alpha2-obstruction.md", "wiki/notes/frontier-szabo-psi-difference-threshold.md"]
---

# Theorem: Szabo psi difference sharp threshold is strictly below 2

## Statement

In Szabo Open Problem 1.5, for every \(0<b-a<1\), the endpoint \(\alpha=2\) is inadmissible; hence any sharp complete-monotonicity threshold satisfies \(\alpha_0<2\).

## Dependencies

- [[wiki/nodes/T-Szabo-psi-difference-alpha2-not-CM|Szabo psi difference endpoint alpha=2 is not completely monotone for all 0<d<1]]
- [[wiki/nodes/T-Szabo-psi-difference-alpha0-exact-one|Szabo psi difference exact alpha0 equals one]]
...
`digamma`, `partial`, `proved`, `szabo`, `theorem`, `threshold`
