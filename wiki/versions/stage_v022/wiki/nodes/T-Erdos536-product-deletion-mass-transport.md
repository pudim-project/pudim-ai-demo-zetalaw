---
id: "T-Erdos536-product-deletion-mass-transport"
type: "theorem"
title: "Erdos536 product deletion mass transport prime biased lower trace multiplicity"
status: "proved"
tags: ["erdos-536", "lower-trace", "mass-transport", "prime-biased", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 product deletion mass transport prime biased lower trace multiplicity

## Statement

Prime-biased product deletion mass transport: for \(q_i=1/p_i\) and \(
u_k(S)=\prod_{i\in S}q_i\prod_{i
otin S}(1-q_i)\), every actual deletion relation \(A=C\setminus D\) satisfies \(
u_k(A)=
u_k(C)\prod_{i\in D}(p_i-1)\). Consequently, if a lower-trace relation has trace multiplicity at most \(M\), then \(\sum_C
u_k(C)\sum_{D\in\mathcal D(C)}\prod_{i\in D}(p_i-1)\le M\), and active tops with average deletion weight at least \(L\) have total mass at most \(M/L\).
...
`erdos-536`, `lower-trace`, `mass-transport`, `prime-biased`, `proved`, `student-proof`, `theorem`, `true`
