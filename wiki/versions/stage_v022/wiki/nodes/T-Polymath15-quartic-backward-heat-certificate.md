---
id: "T-Polymath15-quartic-backward-heat-certificate"
type: "theorem"
...
# Theorem: Polymath15 quartic backward-heat certificate

## Statement

For F0(x)=(x^2-1)(x^2-4), the deformation Ft=exp(-t d^2/dx^2)F0 has only real zeros for every t>=0.
\[
...
- Do not claim a new upper bound for the de Bruijn-Newman constant.
- Do not claim this is a certificate for the Riemann xi function.
- Treat this as a finite source-model heat-flow certificate.

## Tags

`certificate`, `de-bruijn-newman`, `finite-model`, `heat-flow`, `polymath15`, `proved`, `tao-related`, `theorem`
