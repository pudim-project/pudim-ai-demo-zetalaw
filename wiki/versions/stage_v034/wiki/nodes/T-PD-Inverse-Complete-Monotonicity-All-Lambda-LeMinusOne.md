---
id: "T-PD-Inverse-Complete-Monotonicity-All-Lambda-LeMinusOne"
type: "theorem"
title: "Pearse-Bondell inverse complete monotonicity for all lambda <= -1"
status: "proved"
tags: ["app-0092", "archimedean-copula", "complete-monotonicity", "power-divergence", "proved", "source-open-solved", "strict-app-candidate", "theorem", "true"]
parents: ["D-PD-Strict-Inverse-Lambda-LeMinusOne", "L-PD-Inverse-ODE", "L-Positive-Generalized-Power-Series-Flow-Closure"]
refs: ["oracle/responses/OS-20260623T0420-pd-copula-inverse-cm-oracle-response.md", "raw/student/20260623T0428-pd-copula-inverse-cm.md"]
---

# Theorem: Pearse-Bondell inverse complete monotonicity for all lambda <= -1

## Statement

For every \(\lambda\le -1\), the strict inverse \(\phi_\lambda^{-1}\) of the Pearse--Bondell power-divergence generator is strictly completely monotone on \((0,\infty)\) and extends continuously to \(0\) with value \(1\).

## Dependencies

- [[wiki/nodes/D-PD-Strict-Inverse-Lambda-LeMinusOne|Strict inverse in the Pearse-Bondell lambda <= -1 range]]
- [[wiki/nodes/L-PD-Inverse-ODE|Pearse-Bondell inverse ODE]]
- [[wiki/nodes/L-Positive-Generalized-Power-Series-Flow-Closure|Positive generalized-power-series flow closure]]

## Proof and provenance references

- `oracle/responses/OS-20260623T0420-pd-copula-inverse-cm-oracle-response.md`
...
`app-0092`, `archimedean-copula`, `complete-monotonicity`, `power-divergence`, `proved`, `source-open-solved`, `strict-app-candidate`, `theorem`, `true`
