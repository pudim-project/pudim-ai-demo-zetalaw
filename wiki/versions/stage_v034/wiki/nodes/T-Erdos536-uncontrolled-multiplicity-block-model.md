---
id: "T-Erdos536-uncontrolled-multiplicity-block-model"
type: "theorem"
title: "Erdos536 uncontrolled multiplicity block model"
status: "proved"
tags: ["erdos-536", "lower-trace", "multiplicity", "product-measure-model", "proved", "student-proof", "theorem", "true"]
parents: ["T-Erdos536-two-gate-admissibility-data-schema"]
refs: ["attack-plans/AP-20260606T2212-erdos536-multiplicity-antichain-fork.json", "librarian/audits/LA-20260606T2228-erdos536-multiplicity-antichain-fork-depletion-student.json", "oracle/responses/OS-20260606T233242Z-oracle-response.md", "raw/oracle/RO-OS-20260606T233242Z.json", "raw/student/20260606T2228-erdos536-multiplicity-antichain-fork-depletion.md"]
---

# Theorem: Erdos536 uncontrolled multiplicity block model

## Statement

Uncontrolled multiplicity block model: choose disjoint base and tail coordinate blocks with tail prime weight \(\sum_{i\in I_k}1/p_i\in[1,2]\) and \(\max_{i\in I_k}1/p_i	o0\). For every base set \(A\), the tops \(C=A\cup\{i\}\) for \(i\in I_k\) all delete the singleton \(D=\{i\}\) to the same trace \(A\). The trace multiplicity is \(|I_k|	o\infty\), while the event of choosing exactly one tail coordinate has product-measure probability bounded below. Thus uncontrolled multiplicity is a genuine product-measure escape model unless source admissibility, rank-thinness, or shielding excludes it.
...
- `attack-plans/AP-20260606T2212-erdos536-multiplicity-antichain-fork.json`
- `librarian/audits/LA-20260606T2228-erdos536-multiplicity-antichain-fork-depletion-student.json`
- `oracle/responses/OS-20260606T233242Z-oracle-response.md`
- `raw/oracle/RO-OS-20260606T233242Z.json`
- `raw/student/20260606T2228-erdos536-multiplicity-antichain-fork-depletion.md`
...
_Proof source: `raw/student/20260606T2228-erdos536-multiplicity-antichain-fork-depletion.md`._

## Tags

`erdos-536`, `lower-trace`, `multiplicity`, `product-measure-model`, `proved`, `student-proof`, `theorem`, `true`
