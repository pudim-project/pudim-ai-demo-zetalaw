---
id: "T-GGPS-ML-vertical-second-variation-necessary-condition"
type: "theorem"
title: "GGPS Mittag Leffler global inequality implies positive vertical second variation on positive real islands"
status: "proved"
tags: ["mittag-leffler", "necessary-condition", "primitive", "primitive-growth", "proved", "second-variation", "theorem", "true", "vertical-defect"]
parents: []
...
# Theorem: GGPS Mittag Leffler global inequality implies positive vertical second variation on positive real islands

## Statement

If the GGPS global inequality holds and \(E_{\alpha,\beta}(x)>0\), then the vertical second-variation coefficient satisfies \((E_{\alpha,\beta}'(x))^2-E_{\alpha,\beta}(x)E_{\alpha,\beta}''(x)\ge0\).
...
`mittag-leffler`, `necessary-condition`, `primitive`, `primitive-growth`, `proved`, `second-variation`, `theorem`, `true`, `vertical-defect`
