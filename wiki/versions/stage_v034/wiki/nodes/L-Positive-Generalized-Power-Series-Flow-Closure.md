---
id: "L-Positive-Generalized-Power-Series-Flow-Closure"
type: "lemma"
title: "Positive generalized-power-series flow closure"
status: "proved"
tags: ["app-0092-bridge", "bridge", "derivative-chain", "generalized-power-series", "lemma", "positive-coefficients", "primitive-candidate", "proved", "true"]
parents: ["D-Complete-monotonicity-Bernstein-Stieltjes-language", "T-positive-Laplace-kernel-complete-monotonicity-principle"]
refs: ["raw/student/20260623T0428-pd-copula-inverse-cm.md"]
---

# Lemma: Positive generalized-power-series flow closure

## Statement

Let \(\gamma\ge1\) and \(L_\gamma=\gamma x^\gamma(1-x^\gamma)^{-1}d/dx\). For \(P_0(x)=x\) and \(P_{n+1}=L_\gamma P_n\), each \(P_n\) has a locally uniformly convergent generalized power series on \((0,1)\) with strictly positive coefficients and strictly positive exponents. In particular \(P_n(x)>0\) for \(0<x<1\).
...
`app-0092-bridge`, `bridge`, `derivative-chain`, `generalized-power-series`, `lemma`, `positive-coefficients`, `primitive-candidate`, `proved`, `true`
