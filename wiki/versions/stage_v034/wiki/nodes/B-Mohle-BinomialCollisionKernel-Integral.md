---
id: "B-Mohle-BinomialCollisionKernel-Integral"
type: "lemma"
title: "Binomial collision kernel integral"
status: "proved"
tags: ["bridge-lemma", "finite-kernel-certificate", "integral-identity", "lemma", "ordered-pair-kernel", "primitive-support", "proved", "true"]
parents: ["D-Rational-certificate-and-finite-cover-language", "D-Laplace-kernel-and-tilted-moment-language", "T-Exact-finite-certificate-verification-principle"]
...
# Lemma: Binomial collision kernel integral
...
`bridge-lemma`, `finite-kernel-certificate`, `integral-identity`, `lemma`, `ordered-pair-kernel`, `primitive-support`, `proved`, `true`
