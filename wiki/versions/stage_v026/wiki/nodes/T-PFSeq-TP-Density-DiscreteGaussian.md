---
id: "T-PFSeq-TP-Density-DiscreteGaussian"
type: "theorem"
title: "Totally positive Polya-frequency sequences are dense"
status: "proved"
tags: ["application-candidate", "cauchy-binet", "discrete-gaussian", "open-problem-solved", "polya-frequency", "proved", "source-solving", "strict-private-post-v016", "strictification", "theorem", "toeplitz-kernel", "total-positivity", "true"]
parents: ["O-PFSeq-TP-Density-source-gate", "L-DiscreteGaussian-Toeplitz-StrictTP", "L-PFSequence-Annulus-Translate-Independence"]
refs: ["oracle/responses/OS-20260620T073904Z-oracle-response.md", "raw/student/20260620T0755-pfseq-tp-density-positive.md"]
---

# Theorem: Totally positive Polya-frequency sequences are dense
...
- [[wiki/nodes/O-PFSeq-TP-Density-source-gate|Totally positive Polya-frequency sequence density source gate]]
- [[wiki/nodes/L-DiscreteGaussian-Toeplitz-StrictTP|Discrete Gaussian Toeplitz kernels are strictly totally positive]]
- [[wiki/nodes/L-PFSequence-Annulus-Translate-Independence|Non-geometric Polya-frequency sequences have independent translates]]

## Proof and provenance references

- `oracle/responses/OS-20260620T073904Z-oracle-response.md`
...
- Do not state a topology stronger than pointwise/product topology unless separately proved.
- Do not public-stage without user request.
- Do not assign public APP numbering until staging/registry promotion.

## Tags

`application-candidate`, `cauchy-binet`, `discrete-gaussian`, `open-problem-solved`, `polya-frequency`, `proved`, `source-solving`, `strict-private-post-v016`, `strictification`, `theorem`, `toeplitz-kernel`, `total-positivity`, `true`
