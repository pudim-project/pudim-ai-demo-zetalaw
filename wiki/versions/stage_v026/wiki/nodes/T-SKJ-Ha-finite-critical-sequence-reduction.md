---
id: "T-SKJ-Ha-finite-critical-sequence-reduction"
type: "theorem"
...
# Theorem: SKJ CM threshold equals limit of certified finite derivative obstruction sequence
...
- `attack-plans/AP-20260528T003000-skj-power-exponential.json`
- `librarian/audits/LA-20260528T003000-skj-attack-plan.json`
- `wiki/notes/frontier-skj-power-exponential-cm-threshold.md`

## Tags

`attack-plan`, `derivative-recursion`, `finite-obstruction`, `open`, `parameter-threshold`, `stronger`, `theorem`
