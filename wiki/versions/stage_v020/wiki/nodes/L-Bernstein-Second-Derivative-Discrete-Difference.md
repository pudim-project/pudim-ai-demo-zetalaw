---
id: "L-Bernstein-Second-Derivative-Discrete-Difference"
type: "lemma"
title: "Bernstein second derivative is weighted second difference"
status: "proved"
tags: ["bernstein-polynomial", "bridge-lemma", "convexity", "finite-difference", "lemma", "primitive-support", "proved", "true"]
parents: ["D-Bernstein-Polynomial-Basis", "D-q-Monotone-Finite-Difference"]
...
# Lemma: Bernstein second derivative is weighted second difference
...
`bernstein-polynomial`, `bridge-lemma`, `convexity`, `finite-difference`, `lemma`, `primitive-support`, `proved`, `true`
