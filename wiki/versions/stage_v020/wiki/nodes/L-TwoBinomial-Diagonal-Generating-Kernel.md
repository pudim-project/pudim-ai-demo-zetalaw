---
id: "L-TwoBinomial-Diagonal-Generating-Kernel"
type: "lemma"
title: "Two-binomial diagonal generating kernel"
status: "proved"
tags: ["bernstein-polynomial", "bridge-lemma", "coefficient-extraction", "finite-kernel", "lemma", "primitive-growth", "proved", "true"]
parents: ["D-Bernstein-Polynomial-Basis", "T-Exact-finite-certificate-verification-principle"]
...
# Lemma: Two-binomial diagonal generating kernel
...
`bernstein-polynomial`, `bridge-lemma`, `coefficient-extraction`, `finite-kernel`, `lemma`, `primitive-growth`, `proved`, `true`
