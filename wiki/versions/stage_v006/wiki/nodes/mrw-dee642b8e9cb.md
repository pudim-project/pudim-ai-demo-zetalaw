...
- Oracle supplied the high-order \(n\ge29\) obstruction; it was locally checked before inclusion.  The \(n=7\) certificate was found locally before the Oracle response returned.
