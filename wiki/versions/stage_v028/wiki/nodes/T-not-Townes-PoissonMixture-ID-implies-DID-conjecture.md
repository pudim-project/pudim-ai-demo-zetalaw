---
id: "T-not-Townes-PoissonMixture-ID-implies-DID-conjecture"
type: "theorem"
title: "Townes real-valued Poisson-mixture ID-to-DID conjecture is false"
status: "proved"
tags: ["application-candidate", "counterexample", "discrete-infinite-divisibility", "poisson-mixture", "proved", "source-open-solved", "theorem", "townes", "true-negation"]
parents: ["T-not-Townes-FiniteInterval-BLT-Root-Preservation"]
refs: ["librarian/audits/LA-20260609T1616-townes-source-gate.json", "oracle/responses/OS-20260609T1650Z-townes-root-preservation-student-oracle-response.md", "raw/student/20260609T1705-townes-root-preservation-counterexample.md"]
---

# Theorem: Townes real-valued Poisson-mixture ID-to-DID conjecture is false
...
- [[wiki/nodes/T-not-Townes-FiniteInterval-BLT-Root-Preservation|Townes finite-interval BLT root preservation is false]]

## Proof and provenance references

- `librarian/audits/LA-20260609T1616-townes-source-gate.json`
...
- Do not stage publicly without the normal APP registry/staging pass.
- Do not claim the nonnegative-support theorem is false; only the real-valued finite-interval BLT conjecture is refuted.

## Tags

`application-candidate`, `counterexample`, `discrete-infinite-divisibility`, `poisson-mixture`, `proved`, `source-open-solved`, `theorem`, `townes`, `true-negation`
