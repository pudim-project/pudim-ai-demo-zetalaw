---
id: "T-Du-Wang-h3-monotonicity-open"
type: "theorem"
title: "Du Wang h3 monotonicity open problem for 0<a<2"
status: "proved"
tags: ["digamma", "du-wang", "gamma", "monotonicity", "polygamma", "proved", "source-open", "theorem"]
parents: ["T-Du-Wang-h3-open-problem-2-classification"]
refs: ["attack-plans/AP-20260531T052346-du-wang-h3-outer-windows.json", "attack-plans/AP-20260531T214000-du-wang-h3-middle-window.json", "librarian/audits/LA-20260531T220000-du-wang-h3-middle-window-student.json", "oracle/responses/ORACLE-OS-20260531T214200-du-wang-h3-middle-window-oracle-response.md", "raw/scout/sources/du-wang-h3-outer-windows-source-status.md", "raw/source-cache/du-wang-h3-monotonicity/du-wang-h3-monotonicity.txt", "raw/student/20260531T220000-du-wang-h3-middle-window.md", "theory/nodes/T-Du-Wang-h3-open-problem-2-classification.json", "wiki/notes/frontier-du-wang-h3-monotonicity.md"]
---

# Theorem: Du Wang h3 monotonicity open problem for 0<a<2

## Statement

For \(0<a<2\), determine the monotonicity property on \((0,\infty)\) of \(h_3(x)=(-x^2\psi'(x+a)+2x\psi(x+a)-2\log\Gamma(x+a))/x\).

## Dependencies

- [[wiki/nodes/T-Du-Wang-h3-open-problem-2-classification|Du Wang h3 Open Problem 2 classification increasing exactly middle window and nonmonotone outer windows]]
...
- `raw/source-cache/du-wang-h3-monotonicity/du-wang-h3-monotonicity.txt`
- `raw/student/20260531T220000-du-wang-h3-middle-window.md`
- `theory/nodes/T-Du-Wang-h3-open-problem-2-classification.json`
...
`digamma`, `du-wang`, `gamma`, `monotonicity`, `polygamma`, `proved`, `source-open`, `theorem`
