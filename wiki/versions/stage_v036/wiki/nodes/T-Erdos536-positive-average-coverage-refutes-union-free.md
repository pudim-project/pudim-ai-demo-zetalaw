---
id: "T-Erdos536-positive-average-coverage-refutes-union-free"
type: "theorem"
title: "Erdos536 positive average coverage refutes union-free"
status: "proved"
tags: ["coverage", "erdos-536", "lower-trace", "proved", "student-proof", "theorem", "true", "union-free"]
parents: ["T-Erdos536-two-gate-admissibility-data-schema"]
refs: ["attack-plans/AP-20260606T1952-erdos536-two-gate-split.json", "librarian/audits/LA-20260606T2002-erdos536-two-gate-split-depletion-student.json", "oracle/responses/OS-20260606T223439Z-oracle-response.md", "raw/oracle/RO-OS-20260606T223439Z.json", "raw/student/20260606T2002-erdos536-two-gate-split-depletion.md"]
---

# Theorem: Erdos536 positive average coverage refutes union-free

## Statement

Positive average coverage refutes union-free: if a top law \(\tau_k\) is supported on occupied tops and each defect law \(\lambda_C\) is supported on actual proper lower traces below \(C\), then \(\mathbf E_{C\sim\tau_k}\Omega_k(C)>0\) implies distinct \(A,B,C\in\mathcal F_k\) with \(A,B\subsetneq C\) and \(A\cup B=C\). Hence the family is not union-free under the distinct-triple convention.
...
- `attack-plans/AP-20260606T1952-erdos536-two-gate-split.json`
- `librarian/audits/LA-20260606T2002-erdos536-two-gate-split-depletion-student.json`
- `oracle/responses/OS-20260606T223439Z-oracle-response.md`
- `raw/oracle/RO-OS-20260606T223439Z.json`
- `raw/student/20260606T2002-erdos536-two-gate-split-depletion.md`
...
_Proof source: `raw/student/20260606T2002-erdos536-two-gate-split-depletion.md`._

## Tags

`coverage`, `erdos-536`, `lower-trace`, `proved`, `student-proof`, `theorem`, `true`, `union-free`
