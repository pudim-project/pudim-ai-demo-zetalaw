---
id: "T-BergPedersen-HornBernstein-a-NotHausdorff"
type: "theorem"
title: "Horn-Bernstein derived sequence is not Hausdorff"
status: "proved"
tags: ["app-0083-candidate", "app-candidate", "exact-rational-certificate", "finite-difference", "hausdorff-moment", "horn-bernstein", "negative-answer", "primitive-growth", "proved", "source-open-solved", "theorem", "true"]
parents: ["B-HausdorffMoment-FiniteDifference-Criterion", "B-HornBernstein-FirstEight-a-ExactRationals", "O-BergPedersen-HornBernstein-Hausdorff-source-gate"]
refs: ["librarian/audits/LA-20260622T0419-hornbernstein-first-contact.json", "librarian/audits/LA-20260622T0430-hornbernstein-strict-app.json", "oracle/responses/OS-20260622T042303Z-oracle-response.md", "raw/oracle/RO-OS-20260622T042303Z.json", "raw/student/20260622T0428-hornbernstein-seventh-difference.md"]
---

# Theorem: Horn-Bernstein derived sequence is not Hausdorff
...
- [[wiki/nodes/B-HausdorffMoment-FiniteDifference-Criterion|Hausdorff finite-difference criterion]]
- [[wiki/nodes/B-HornBernstein-FirstEight-a-ExactRationals|Horn-Bernstein first eight exact values]]
...
- Do not claim any result about \((t_n^c)\) beyond the source's conditional implication.
- Do not claim the source sequence \((t_n)\) itself is or is not infinitely divisible in the Hausdorff sense.
- Do not public-stage without explicit user request.

## Tags

`app-0083-candidate`, `app-candidate`, `exact-rational-certificate`, `finite-difference`, `hausdorff-moment`, `horn-bernstein`, `negative-answer`, `primitive-growth`, `proved`, `source-open-solved`, `theorem`, `true`
