---
id: "T-HeatFlow-radial-Dfunctional-normal-form"
type: "theorem"
title: "heat flow Fisher D functional radial one dimensional normal form"
status: "proved"
tags: ["fisher-information", "heat-flow", "one-dimensional-integral", "primitive", "primitive-growth", "proved", "radial-reduction", "theorem", "true"]
parents: []
...
# Theorem: heat flow Fisher D functional radial one dimensional normal form

## Statement

For a radial density \(f(x)=Z^{-1}e^{-V(|x|)}\), with \(a=V''\) and \(b=V'/r\), the heat-flow Fisher functional reduces to the one-dimensional polar integral with integrand \((a')^2+(d-1)(b')^2+2(d-1)(a-b)^2/r^2+2a^3+2(d-1)b^3\).
...
`fisher-information`, `heat-flow`, `one-dimensional-integral`, `primitive`, `primitive-growth`, `proved`, `radial-reduction`, `theorem`, `true`
