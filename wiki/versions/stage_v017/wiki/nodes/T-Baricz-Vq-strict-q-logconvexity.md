---
id: "T-Baricz-Vq-strict-q-logconvexity"
type: "theorem"
title: "Baricz V_q strictly log-convex in q"
status: "proved"
tags: ["attack-plan", "complete-monotonicity", "log-convexity", "proved", "source-solving", "theorem"]
parents: ["T-Baricz-Vq-q-complete-monotonicity"]
refs: ["private attack plan", "private librarian audit", "private proof note", "wiki/notes/frontier-baricz-vq-logconvexity.md"]
---

# Theorem: Baricz V_q strictly log-convex in q
...
- [[wiki/nodes/T-Baricz-Vq-q-complete-monotonicity|Baricz V_q completely monotone in parameter q plus one]]
...
`attack-plan`, `complete-monotonicity`, `log-convexity`, `proved`, `source-solving`, `theorem`
