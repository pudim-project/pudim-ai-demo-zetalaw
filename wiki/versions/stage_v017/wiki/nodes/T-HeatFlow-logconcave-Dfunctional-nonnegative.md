---
id: "T-HeatFlow-logconcave-Dfunctional-nonnegative"
type: "theorem"
title: "heat flow Fisher D functional nonnegative for log concave densities"
status: "proved"
tags: ["barrier-lemma", "displayed-kernel-positivity", "fisher-information", "heat-flow", "log-concavity", "primitive", "primitive-growth", "proved", "theorem", "true"]
parents: []
...
# Theorem: heat flow Fisher D functional nonnegative for log concave densities

## Statement

For the heat-flow Fisher functional \(D[f]=\int(|\nabla H_f|^2+2\operatorname{tr}(H_f^3))f\), if \(f\) is log-concave, then \(D[f]\ge0\).
...
`barrier-lemma`, `displayed-kernel-positivity`, `fisher-information`, `heat-flow`, `log-concavity`, `primitive`, `primitive-growth`, `proved`, `theorem`, `true`
