---
id: "T-GGPS-ML-h-small-x-convexity"
type: "theorem"
title: "GGPS h small-x expansion and local convexity"
status: "proved"
tags: ["asymptotic", "attack-plan", "convexity", "gamma", "proved", "stronger", "theorem"]
parents: ["T-endpoint-log-derivative-monotonicity-principle"]
refs: ["private attack plan", "private librarian audit", "private librarian audit", "private proof note", "wiki/notes/frontier-ggps-ml-h-convexity.md"]
---

# Theorem: GGPS h small-x expansion and local convexity

## Statement

The GGPS boundary function has the small-\(x\) expansion \(h(x)=(\sqrt2-1)x+(\sqrt2\pi^2/12)x^3+O(x^4)\); consequently \(h''(x)>0\) for all sufficiently small positive \(x\).
...
`asymptotic`, `attack-plan`, `convexity`, `gamma`, `proved`, `stronger`, `theorem`
