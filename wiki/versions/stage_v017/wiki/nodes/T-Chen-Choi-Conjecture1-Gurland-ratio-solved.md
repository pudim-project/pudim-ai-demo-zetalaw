---
id: "T-Chen-Choi-Conjecture1-Gurland-ratio-solved"
type: "theorem"
title: "Chen Choi Conjecture 1 Gurland ratio solved"
status: "proved"
tags: ["application-candidate", "chen-choi", "gurland-ratio", "open-problem-solved", "proved", "theorem"]
parents: ["T-Chen-Choi-Gurland-logF-strict-CM"]
refs: ["private attack plan", "private Oracle response", "private Oracle response", "private scout artifact", "raw/source-cache/chen-choi-gurland-ratio/mia-20-43.pdf", "raw/source-cache/chen-choi-gurland-ratio/mia-20-43.txt", "raw/source-cache/chen-choi-gurland-ratio/mia-22-07-yang-zheng.txt", "private proof note", "wiki/notes/frontier-chen-choi-gurland-logcm.md"]
---

# Theorem: Chen Choi Conjecture 1 Gurland ratio solved

## Statement

Chen-Choi Conjecture 1 holds: \((-1)^n(\log F(x))^{(n)}>0\) for \(x>0\) and \(n\in\mathbb N_0\), where \(F(x)=\Gamma(1/x)\Gamma(3/x)/\Gamma(2/x)^2\).

## Dependencies

- [[wiki/nodes/T-Chen-Choi-Gurland-logF-strict-CM|Chen Choi Gurland log F strictly completely monotone]]
...
`application-candidate`, `chen-choi`, `gurland-ratio`, `open-problem-solved`, `proved`, `theorem`
