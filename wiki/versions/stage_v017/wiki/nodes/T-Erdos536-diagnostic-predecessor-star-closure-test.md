...
parents: ["T-Erdos536-two-gate-admissibility-data-schema", "T-Finite-combinatorial-packing-shadow-principle", "T-Erdos536-full-predecessor-window-closure-has-forks"]
refs: ["private attack plan", "private librarian audit", "private librarian audit", "private proof note", "private proof note", "theory/nodes/T-Erdos536-diagnostic-locally-unique-positive-mass-code-obstruction.json", "theory/nodes/T-Erdos536-full-predecessor-window-closure-has-forks.json", "theory/nodes/T-Erdos536-linear-window-predecessor-star-code-avoids-pushforward.json"]
---
