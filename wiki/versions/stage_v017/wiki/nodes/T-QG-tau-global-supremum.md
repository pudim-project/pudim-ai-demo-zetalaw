---
id: "T-QG-tau-global-supremum"
type: "theorem"
title: "Qi Guo tau global supremum equals a over 1+a+a^2 where exp(a)=1+a+a^2"
status: "proved"
tags: ["application-bridge", "extremal-theorem", "gamma-digamma", "optimization-method", "proved", "qi-guo", "source-solving", "supremum-theorem", "theorem", "threshold"]
parents: ["T-endpoint-log-derivative-monotonicity-principle"]
refs: ["private librarian audit", "private Oracle response", "private scout artifact", "private proof note", "wiki/notes/frontier-qg-tau-threshold.md"]
---

# Theorem: Qi Guo tau global supremum equals a over 1+a+a^2 where exp(a)=1+a+a^2
...
`application-bridge`, `extremal-theorem`, `gamma-digamma`, `optimization-method`, `proved`, `qi-guo`, `source-solving`, `supremum-theorem`, `theorem`, `threshold`
