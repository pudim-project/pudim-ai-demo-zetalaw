---
id: "L-Signed-Atomic-Hausdorff-Negativity-Obstruction"
type: "lemma"
title: "signed atomic Hausdorff negative atom obstruction positive measure uniqueness"
status: "proved"
tags: ["bridge-lemma", "finite-certificate", "hausdorff-moment", "lemma", "negative-atom", "primitive-growth", "proved", "signed-measure", "true"]
parents: ["T-Pointwise-obstruction-certificate-principle", "T-Exact-finite-certificate-verification-principle"]
...
# Lemma: signed atomic Hausdorff negative atom obstruction positive measure uniqueness
...
`bridge-lemma`, `finite-certificate`, `hausdorff-moment`, `lemma`, `negative-atom`, `primitive-growth`, `proved`, `signed-measure`, `true`
