---
id: "T-Bazhlekova-inner-gap-higher-odd-derivative-seeds"
type: "theorem"
title: "Bazhlekova residual inner gap exact fifth seventh ninth derivative failure seeds"
status: "proved"
...
# Theorem: Bazhlekova residual inner gap exact fifth seventh ninth derivative failure seeds

## Statement

Inside the Bazhlekova residual inner gap, the derivative-polynomial criterion gives exact uniform \(w_t\)-positivity failures at \((a,b)=(28/25,1/50)\) by \(Q_5(1)<0\), at \((a,b)=(107/100,1/100)\) by \(Q_7(3/2)<0\), and at \((a,b)=(53/50,1/100)\) by \(Q_9(7/4)<0\).
