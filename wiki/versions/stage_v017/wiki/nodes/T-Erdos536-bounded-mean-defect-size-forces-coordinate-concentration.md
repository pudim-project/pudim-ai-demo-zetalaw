---
id: "T-Erdos536-bounded-mean-defect-size-forces-coordinate-concentration"
type: "theorem"
title: "Erdos536 bounded mean defect size forces coordinate concentration"
status: "proved"
tags: ["bounded-mean", "coordinate-energy", "defect-sets", "erdos-536", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 bounded mean defect size forces coordinate concentration

## Statement

Bounded-mean defect-size coordinate lemma: for coordinate marginals \(q_i=\lambda(i\in D)\), if \(M=\sum_i q_i=\mathbf E|D|\) and \(I=\sum_i q_i^2\), then \(I\le(\max_i q_i)M\). Hence if a union-free lower-trace-rich branch has \(I\ge1\) and \(M\le M_0\), then \(\max_i q_i\ge1/M_0\).
...
`bounded-mean`, `coordinate-energy`, `defect-sets`, `erdos-536`, `proved`, `student-proof`, `theorem`, `true`
