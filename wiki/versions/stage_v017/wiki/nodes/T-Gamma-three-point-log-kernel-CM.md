---
id: "T-Gamma-three-point-log-kernel-CM"
type: "theorem"
title: "three point logarithmic kernel complete monotone"
status: "proved"
tags: ["complete-monotonicity", "gamma", "laplace-kernel", "proved", "theorem"]
...
# Theorem: three point logarithmic kernel complete monotone

## Statement

The function \(A(u)=2\log(u+2)-\log(u+1)-\log(u+3)\) is strictly completely monotone on \((0,\infty)\).
...
`complete-monotonicity`, `gamma`, `laplace-kernel`, `proved`, `theorem`
