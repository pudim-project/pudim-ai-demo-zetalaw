---
id: "T-Bazhlekova-two-term-concavity-region-no-positivity"
type: "theorem"
title: "Bazhlekova two-term gap outside unit disk no propagation positivity package"
status: "proved"
tags: ["bazhlekova", "bernstein-function", "complete-monotonicity", "diffusion-wave", "no-relaxation-region", "not-staging-application", "proved", "source-facing-partial", "theorem"]
parents: ["T-Complete-monotonicity-closure-calculus-principle", "T-sqrt-two-term-symbol-concavity-loss-criterion"]
refs: ["private attack plan", "private librarian audit", "private proof note", "wiki/notes/frontier-bazhlekova-square-root-bf-gap.md"]
---

# Theorem: Bazhlekova two-term gap outside unit disk no propagation positivity package

## Statement

For \(g(s)=c s^a+d s^b\), \(c,d>0\), \(1<a\le2\), \(0<b<a-1\), and \((a-1)^2+(b-1)^2>1\), Bazhlekova's propagation positivity package cannot hold for all \(x,t>0\).

## Dependencies

- [[wiki/nodes/T-Complete-monotonicity-closure-calculus-principle|Complete-monotonicity closure calculus principle]]
- [[wiki/nodes/T-sqrt-two-term-symbol-concavity-loss-criterion|sqrt(c s^a+d s^b) two-term concavity loss criterion outside unit disk centered at (1,1)]]
...
`bazhlekova`, `bernstein-function`, `complete-monotonicity`, `diffusion-wave`, `no-relaxation-region`, `not-staging-application`, `proved`, `source-facing-partial`, `theorem`
