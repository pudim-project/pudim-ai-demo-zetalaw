---
id: "T-Popa-Tao-M4-selfcommutator-spectral-radius-formula"
type: "theorem"
title: "T-Popa-Tao-M4-selfcommutator-spectral-radius-formula"
status: "proved"
tags: ["proved", "theorem"]
parents: ["T-Popa-Tao-Mn-trace-neutral-selfcommutator-Horn-invariant", "T-Popa-Tao-M3-trace-neutral-self-commutator-normal-form", "T-Popa-Tao-M5-trace-neutral-selfcommutator-spectral-radius-counterexample", "T-Finite-matrix-spectral-certificate-principle"]
refs: ["private Oracle response", "private proof note", "wiki/notes/tao-popa-M4-selfcommutator-classification.md"]
---

# Theorem: T-Popa-Tao-M4-selfcommutator-spectral-radius-formula

## Statement

For every trace-zero Hermitian H in M4(C), inf{||V||^2 : H=VV^*-V^*V}=max(lambda_max(H),-lambda_min(H)).

## Scope

- Finite-dimensional trace-neutral Hermitian self-commutator classification in M4; not a solution of Tao's infinite B(H) model.
