---
id: "T-Yin-pk-digamma-alpha-necessity"
type: "theorem"
title: "Yin p,k-digamma complete monotonicity implies alpha <= 1"
status: "proved"
tags: ["attack-plan", "complete-monotonicity", "endpoint-obstruction", "proved", "source-solving", "theorem"]
parents: ["D-Complete-monotonicity-Bernstein-Stieltjes-language", "T-Yin-pk-digamma-near-zero-asymptotic"]
refs: ["private attack plan", "private librarian audit", "private proof note", "wiki/notes/frontier-yin-pk-digamma-alpha-necessity.md"]
---

# Theorem: Yin p,k-digamma complete monotonicity implies alpha <= 1
...
- [[wiki/nodes/T-Yin-pk-digamma-near-zero-asymptotic|Yin p,k-digamma bracket near zero asymptotic x inverse]]
...
`attack-plan`, `complete-monotonicity`, `endpoint-obstruction`, `proved`, `source-solving`, `theorem`
