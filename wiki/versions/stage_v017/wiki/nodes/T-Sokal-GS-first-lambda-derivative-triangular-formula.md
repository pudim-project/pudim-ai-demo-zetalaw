---
id: "T-Sokal-GS-first-lambda-derivative-triangular-formula"
type: "theorem"
title: "first lambda derivative of Sokal generalized Stieltjes tests is positive triangular combination"
status: "proved"
tags: ["bridge-patch", "derivative-test", "generalized-stieltjes", "positive-coefficients", "proved", "sokal", "theorem"]
...
# Theorem: first lambda derivative of Sokal generalized Stieltjes tests is positive triangular combination

## Statement

For Sokal's generalized-Stieltjes tests, \(\partial_\lambda F^{[\lambda]}_{n,k}(x)=\sum_{r=0}^{k-1} k!F^{[\lambda]}_{n,r}(x)/(r!(k-r))\) for \(k\ge1\), with the \(k=0\) derivative equal to \(0\).
...
`bridge-patch`, `derivative-test`, `generalized-stieltjes`, `positive-coefficients`, `proved`, `sokal`, `theorem`
