---
id: "T-Erdos536-finite-core-conditional-antichain-sink"
type: "theorem"
title: "Erdos536 finite core conditional antichain sink"
status: "proved"
tags: ["antichain", "erdos-536", "finite-core", "prime-biased", "proved", "student-proof", "theorem", "true"]
...
# Theorem: Erdos536 finite core conditional antichain sink

## Statement

Finite-core conditional antichain sink: after conditioning the prime-biased product law on any fixed finite coordinate pattern, the remaining tail product law still has divergent variance, so every tail antichain has conditional mass \(o(1)\). Thus fixed finite-core shields do not by themselves create positive-mass high-support antichain obstructions; they must be treated as core/shield descent states.
...
`antichain`, `erdos-536`, `finite-core`, `prime-biased`, `proved`, `student-proof`, `theorem`, `true`
