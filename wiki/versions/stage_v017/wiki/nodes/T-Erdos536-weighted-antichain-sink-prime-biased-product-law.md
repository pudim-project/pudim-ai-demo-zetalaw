---
id: "T-Erdos536-weighted-antichain-sink-prime-biased-product-law"
type: "theorem"
title: "Erdos536 weighted antichain sink prime biased product law"
status: "proved"
tags: ["antichain", "erdos-536", "prime-biased", "proved", "student-proof", "theorem", "true", "weighted-lym"]
...
# Theorem: Erdos536 weighted antichain sink prime biased product law

## Statement

Weighted antichain sink for the prime-biased product law: for \(\nu_k=\bigotimes_{i\le k}\operatorname{Bernoulli}(1/p_i)\) and every antichain \(\mathcal A_k\subseteq2^{[k]}\), one has \(\nu_k(\mathcal A_k)\le\sup_m\nu_k(|S|=m)\le C V_k^{-1/2}=o(1)\), where \(V_k=\sum_{i\le k}(1/p_i)(1-1/p_i)\).
...
`antichain`, `erdos-536`, `prime-biased`, `proved`, `student-proof`, `theorem`, `true`, `weighted-lym`
