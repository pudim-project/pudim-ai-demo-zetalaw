...
- `versions/stage_v023/`: immutable wiki snapshot matching theory `v023`.
...
Direct node paths are `wiki/latest/wiki/nodes/` for the latest vault and `wiki/versions/stage_v023/wiki/nodes/` for the current immutable snapshot. The file `T-Tao-Sawin-Weyl-l1-exact-minimum.md`, for example, lives at `wiki/latest/wiki/nodes/T-Tao-Sawin-Weyl-l1-exact-minimum.md`.
