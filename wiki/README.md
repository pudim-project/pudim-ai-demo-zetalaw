...
- `versions/stage_v036/`: immutable wiki snapshot matching theory `v036`.
- `versions/stage_v001/`--`versions/stage_v036/`: immutable wiki snapshots.
- Each vault contains `Home.md`, `GOAL.md`, `STATUS.md`, `STRATEGY.md`, `wiki/index.md`, `wiki/graph.json`, and `wiki/nodes/`.

Direct node paths are `wiki/latest/wiki/nodes/` for the latest vault and `wiki/versions/stage_v036/wiki/nodes/` for the current immutable snapshot. The file `T-Tao-Sawin-Weyl-l1-exact-minimum.md`, for example, lives at `wiki/latest/wiki/nodes/T-Tao-Sawin-Weyl-l1-exact-minimum.md`.
...
- total nodes: 1003
- by type: corollary: 4, counterexample: 2, definition: 48, example: 1, lemma: 84, negative_result: 4, obstruction: 1, obstruction_lemma: 1, obstruction_theorem: 1, open_problem: 112, proposition: 3, theorem: 741, theorem_import: 1
- by status: accepted_local_node: 1, open: 352, proved: 635, proved_local: 11, resolved: 4
