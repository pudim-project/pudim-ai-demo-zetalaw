---
id: "T-HeatFlow-torus-negative-transfers-to-Euclidean-negative"
type: "theorem"
title: "negative torus heat flow Fisher D certificate transfers to Euclidean Gaussian decaying density"
status: "proved"
tags: ["conditional-counterexample-route", "fisher-information", "gaussian-envelope", "heat-flow", "primitive", "primitive-growth", "proved", "theorem", "torus-transfer", "true"]
parents: []
refs: ["private librarian audit", "private Oracle response", "private proof note", "wiki/notes/frontier-heatflow-fisher-dfunctional-negativity.md"]
---

# Theorem: negative torus heat flow Fisher D certificate transfers to Euclidean Gaussian decaying density

## Statement

If a smooth periodic potential on \(\mathbb T^d\) has negative torus-averaged heat-flow Fisher functional \(D_T[u]<0\), then a Gaussian-envelope periodization produces a smooth strictly positive Gaussian-decaying density on \(\mathbb R^d\) with \(D[f]<0\).
...
`conditional-counterexample-route`, `fisher-information`, `gaussian-envelope`, `heat-flow`, `primitive`, `primitive-growth`, `proved`, `theorem`, `torus-transfer`, `true`
