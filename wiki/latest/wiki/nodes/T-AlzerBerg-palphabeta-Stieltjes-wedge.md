---
id: "T-AlzerBerg-palphabeta-Stieltjes-wedge"
type: "theorem"
title: "Alzer-Berg p alpha beta Stieltjes wedge"
status: "proved"
tags: ["alzer-berg", "bridge-result", "complete-monotonicity", "laplace-density", "parameter-region", "proved", "stieltjes", "theorem", "true"]
parents: ["D-AlzerBerg-EulerLimit-palphabeta-Language", "D-Complete-monotonicity-Bernstein-Stieltjes-language", "D-Laplace-kernel-and-tilted-moment-language", "O-AlzerBerg-EulerLimit-palphabeta-CM-source-gate"]
refs: ["private librarian audit", "private Oracle response", "private proof note"]
---

# Theorem: Alzer-Berg p alpha beta Stieltjes wedge

## Statement

If \(-1<\beta\le0\) and \(0<\alpha\le\beta+1\), then \(p_{\alpha,\beta}(x)=e^\alpha-(1+\alpha/x)^{x+\beta}\) is a Stieltjes function on \((0,\infty)\), hence is completely monotone.
...
`alzer-berg`, `bridge-result`, `complete-monotonicity`, `laplace-density`, `parameter-region`, `proved`, `stieltjes`, `theorem`, `true`
