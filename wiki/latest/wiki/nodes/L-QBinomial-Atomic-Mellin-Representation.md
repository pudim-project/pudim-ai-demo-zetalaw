---
id: "L-QBinomial-Atomic-Mellin-Representation"
type: "lemma"
title: "q-binomial atomic Mellin representation for q-gamma"
status: "proved"
tags: ["bridge", "lemma", "mellin-transform", "positive-measure", "proved", "q-binomial", "q-gamma", "true"]
parents: ["D-QGamma-Pochhammer-PositiveAxis"]
refs: []
---

# Lemma: q-binomial atomic Mellin representation for q-gamma
...
- [[wiki/nodes/D-QGamma-Pochhammer-PositiveAxis|q-gamma and q-Pochhammer notation on the positive axis]]
...
`bridge`, `lemma`, `mellin-transform`, `positive-measure`, `proved`, `q-binomial`, `q-gamma`, `true`
