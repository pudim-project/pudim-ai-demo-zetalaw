---
id: "T-Li-CubicInversePolynomial-BF-Discriminant"
type: "theorem"
title: "Li cubic inverse-polynomial Bernstein branch has discriminant criterion"
status: "proved"
tags: ["application-candidate", "bernstein-functions", "coefficient-classification", "complete-monotonicity", "inverse-functions", "open-problem-solved", "pringsheim-obstruction", "proved", "source-solving", "strict-private-plus10", "theorem", "true"]
parents: ["D-InversePolynomialBFProblem", "L-QuadraticDenominator-CM-NonpositiveRoots", "L-InverseODE-CM-to-BF", "L-AnalyticBF-Pringsheim-NegativeAxisObstruction", "O-Li-InversePolynomial-CubicBF-source-gate"]
refs: ["librarian/audits/LA-20260613T2228-li-cubic-strict-app.json", "oracle/responses/OS-20260613T221216Z-oracle-response.md", "raw/student/20260613T2225-li-cubic-inverse-bf-discriminant.md"]
---

# Theorem: Li cubic inverse-polynomial Bernstein branch has discriminant criterion
...
- [[wiki/nodes/D-InversePolynomialBFProblem|Inverse-polynomial Bernstein coefficient problem]]
- [[wiki/nodes/L-QuadraticDenominator-CM-NonpositiveRoots|Quadratic denominator with nonpositive roots is completely monotone]]
- [[wiki/nodes/L-InverseODE-CM-to-BF|Completely monotone inverse ODE implies Bernstein inverse]]
- [[wiki/nodes/L-AnalyticBF-Pringsheim-NegativeAxisObstruction|Analytic Bernstein functions have a Pringsheim negative-axis obstruction]]
- [[wiki/nodes/O-Li-InversePolynomial-CubicBF-source-gate|Li inverse-polynomial cubic Bernstein source gate]]

## Proof and provenance references

- `librarian/audits/LA-20260613T2228-li-cubic-strict-app.json`
- `oracle/responses/OS-20260613T221216Z-oracle-response.md`
...
- Do not claim Li explicitly conjectured \(a^2\ge3b\).
- Do not claim the general \(n\)-coefficient inverse-polynomial problem is solved.
- Do not claim public APP registry assignment.
- Do not public-stage without user request.

## Tags

`application-candidate`, `bernstein-functions`, `coefficient-classification`, `complete-monotonicity`, `inverse-functions`, `open-problem-solved`, `pringsheim-obstruction`, `proved`, `source-solving`, `strict-private-plus10`, `theorem`, `true`
