...
| APP-0019 | Wakrim proves non-Bernstein behavior for \(\beta>1\) and leaves the \(0<\beta\le1\) W-symbol range open (2026). | Wakrim's obstruction gives the non-Bernstein side; the staged derivative-factorization proof closes the remaining Bernstein side \(0\le\beta\le1\). | [Wakrim, arXiv:2601.02876](https://arxiv.org/abs/2601.02876) | Solved |
